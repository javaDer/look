...
export const toolsByCategory = [
  ...
  },
  {
    ...
    components: [
      ...
      tool('integer-base-converter', 'Integer base converter', 'base-converter', ['binary', 'hex']),
  ...
  },
  {
    ...
    components: [
      ...
      tool('meta-tag-generator', 'Meta tag generator', 'og-meta-generator', ['seo']),
      tool('otp-code-generator-and-validator', 'OTP code generator and validator', 'otp-generator', ['totp']),
  ...
  },
  {
    ...
    components: [
      tool('qr-code-generator', 'QR code generator', 'qrcode-generator', ['qr']),
      tool('wifi-qr-code-generator', 'WiFi QR code generator', 'wifi-qrcode-generator', ['wifi']),
  ...
  },
  {
    ...
    components: [
      ...
      tool('json-viewer', 'JSON viewer', 'json-prettify', ['format', 'prettify']),
      ...
      tool('yaml-viewer', 'YAML viewer', 'yaml-prettify', ['yaml']),
